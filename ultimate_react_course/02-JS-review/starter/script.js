...
// however, this approach may become cumbersome when we have to extract many properties from an object. Instead, we can use destructuring to make our code cleaner and more concise.
const {pages, publicationDate, genres, hasMovieAdaption} = book;
pages;
publicationDate;
genres;
hasMovieAdaption;
